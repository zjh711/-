export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd7e95d3d2f5f0d05",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "84905753545ffca95db2537804d53f09",
  ...
  USERS: [
    {
      ...
      id: "o1ywq643JUO79h12EErvkVIk5N48",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "5kdKoUBHSoQjFtpHh1SQwf65qL9eeAjM9GSLpwISOHE",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "烟台",
